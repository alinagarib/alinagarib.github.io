...
async function fetchProfile() {
    ...
    div.innerHTML = `
    ${data.profile_image ? `<a href="https://open.spotify.com/user/alinagrb" target="_blank"><img src="${data.profile_image}" width="200"></a>` : ""}
    <p><strong><a href="https://open.spotify.com/user/alinagrb" target="_blank">${data.display_name}</a></strong></p>
  `;
}
...
async function fetchTopRecent(limit = 3, days = 7) {
    ...
    function showTrack(index) {
        ...
        setTimeout(() => {
            ...
            <p style="color: hotpink">${track.plays} recent listens</p>
            `;
            div.style.opacity = 1;
        }, 200);
    }
